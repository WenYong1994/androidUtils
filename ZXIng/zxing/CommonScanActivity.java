 ...
 */
package com.zhidujia.zhidu.uis.activitys;
...
import com.zhidujia.zhidu.constant.Constant;
import com.zhidujia.zhidu.zxing.ScanListener;
import com.zhidujia.zhidu.zxing.ScanManager;
import com.zhidujia.zhidu.zxing.decode.DecodeThread;
import com.zhidujia.zhidu.zxing.decode.Utils;
...
//		Toast.makeText(that, "result="+rawResult.getText(), Toast.LENGTH_LONG).show();
       ...
       //     scan_image.setVisibility(View.VISIBLE);
        ...
        if (true){
            ...
            tv_scan_result.setText("结果："+rawResult.getText()+"不符合要求");
        }
